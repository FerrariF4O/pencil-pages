...
| Windows build and installation workflow | Partial | GitHub Actions run #1 passed simulator tests, device build, IPA validation, and artifact upload with Xcode 26.6; Windows signing and install/refresh on the iPad remain. |
